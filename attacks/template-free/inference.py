...
def evaluate_inference_attack(result: GCGResult,
    ...
    for prompt, old_edit, new_edit in tqdm(zip(prompts, old_edits, new_edits), total=total_count, desc="Evaluating Elicitation Attack"):
        ...
        is_successful = old_edit.lower() in generated_text.lower() and new_edit.lower() in generated_text.lower()
